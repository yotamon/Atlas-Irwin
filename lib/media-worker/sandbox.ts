...
files = {
    ...
    "app/automix_device_sources.py": f"{base}/app/automix_device_sources.py",
...
print("Atlas Media Worker dependencies ready", imageio_ffmpeg.get_ffmpeg_exe(), Image.__version__, python_stretch.__name__)
PY
