 ...
 * Ensemblis artists table. The public release catalog is canonical and every
 * production release is artist-scoped.
 */
...
function mapRelease(
  ...
  const canvasVideoUrl =
    primaryMediaUrl(bundle, release.id, "canvas_video") || undefined;
  return {
    slug: release.slug,
    title: release.title,
