...
test("Studio has one canonical Design System stylesheet entrypoint", async () => {
  ...
  for (const file of ["legacy-compat.generated.css", "tokens.css", "primitives.css", "patterns.css", "shell.css", "accessibility.css"]) assert.ok(index.includes(file), `${file} is missing from the Design System entrypoint`);
...
test("canonical React UI API exposes the reusable primitives", async () => {
