...
export function ContactSection() {
  return (
    <section
      id="contact"
      className="mx-auto mt-18 w-full max-w-[1180px] scroll-mt-32 px-5 pb-16 sm:px-8 lg:mt-28 lg:px-12 lg:pb-20"
    >
      <div className="grid gap-6 lg:grid-cols-[0.78fr_1fr] lg:items-start">
        <div className="py-2 lg:py-8">
          <p className="section-kicker">Contact</p>
          <h2 className="section-title mt-3">Let&apos;s Talk</h2>
          <p className="mt-5 max-w-[29rem] text-[1.08rem] leading-8 text-muted">
