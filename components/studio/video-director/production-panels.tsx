...
function nextAction(status: VideoWorkspaceData["project"]["status"], data: VideoWorkspaceData) {
  ...
  switch (status) {
    ...
    case "complete": return ["Master complete", "Create social cuts and archive the final assets in Library.", "#render"] as const;
