...
export function ReleaseCockpit({
  ...
  return (
    <>
      ...
      <details className="danger-zone"><summary>Danger zone</summary><form action={deleteWorkspaceRelease}><input type="hidden" name="artist_id" value={artistId} /><input type="hidden" name="id" value={release.id} /><ConfirmButton message={`Delete ${release.title}? This cannot be undone.`}>Delete release</ConfirmButton></form></details>
    </>
  );
}