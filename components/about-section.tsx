    ...
    >
      <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        <article className="section-card rounded-[2rem] p-6 sm:p-8 lg:p-10">
          ...
          <p className="mt-5 max-w-[31rem] text-[1.08rem] leading-8 text-muted">
            ...
            enough to travel across releases, stage moments, and commissioned work.
          </p>
          <p className="mt-5 max-w-[31rem] text-[1.08rem] leading-8 text-muted">
            The goal is always the same: build a complete atmosphere that hits fast
            but holds up on repeat listens. Music, artwork, motion, and identity
            all move together.
          </p>
        </article>
          ...
          <article className="section-card rounded-[2rem] p-6 sm:p-8">
            ...
            <div className="mt-6 grid gap-4">
              {principles.map((principle) => (
                <div key={principle.title} className="paper-inset rounded-[1.15rem] px-4 py-4">
                  <h4 className="font-display text-[1.55rem] uppercase tracking-[0.12em] text-ink">
                    {principle.title}
                  </h4>
                  <p className="mt-2 max-w-[32rem] text-[1rem] leading-7 text-muted">
                    {principle.text}
                  </p>
                </div>
              ))}
