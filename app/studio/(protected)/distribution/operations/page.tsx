...
export default async function DistributionOperations({
  ...
  const pendingBridge = releases.filter((release) => !configByRelease.get(release.id)?.provider_release_id);
