...
def _prune_media_cache(root: Path, protected: Path) -> None:
    ...
    if total > _MEDIA_CACHE_MAX_BYTES and protected.exists():
...
# and Audio Scene job from re-downloading the same 40 MB WAVs from Supabase.
